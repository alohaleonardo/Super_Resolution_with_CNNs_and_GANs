...
class Generator(nn.Module):
    ...
    def forward(self, x):
        ...
        for params in self.block1.parameters():
            params.require_grad = False
        for params in self.block2.parameters():
            params.require_grad = False
        for params in self.block3.parameters():
            params.require_grad = False
        for params in self.block4.parameters():
            params.require_grad = False
        for params in self.block5.parameters():
            params.require_grad = False
