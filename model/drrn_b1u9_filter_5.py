...
class Net(nn.Module):
    def __init__(self, params):
        ...
        self.input = nn.Conv2d(in_channels=3, out_channels=128, kernel_size=5, stride=1, padding=2, bias=False)
        self.conv1 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=5, stride=1, padding=2, bias=False)
        self.conv2 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=5, stride=1, padding=2, bias=False)
        self.output = nn.Conv2d(in_channels=128, out_channels=3, kernel_size=5, stride=1, padding=2, bias=False)
